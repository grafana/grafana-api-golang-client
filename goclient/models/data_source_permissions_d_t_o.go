...
func (m *DataSourcePermissionsDTO) validatePermissions(formats strfmt.Registry) error {
...
func (m *DataSourcePermissionsDTO) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataSourcePermissionsDTO) UnmarshalBinary(b []byte) error {
	var res DataSourcePermissionsDTO
