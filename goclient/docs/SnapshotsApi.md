...
# **CreateSnapshot**
> InlineResponse20014Model CreateSnapshot(ctx, body)
...
[**InlineResponse20014Model**](inline_response_200_14.md)
...
> SuccessResponseBodyModel DeleteSnapshotByDeleteKey(ctx, deleteKey)
...
# **DeleteSnapshotByKey**
> SuccessResponseBodyModel DeleteSnapshotByKey(ctx, key)
...
> InlineResponse20013Model GetSnapshotSharingOptions(ctx, )
...
[**InlineResponse20013Model**](inline_response_200_13.md)
...
# **GetSnapshots**
> []DashboardSnapshotDtoModel GetSnapshots(ctx, optional)
List snapshots.
...
[**[]DashboardSnapshotDtoModel**](DashboardSnapshotDTO.md)
